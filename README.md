...
- [.gitattributes](./.gitattributes) treats the downloaded logos as binary assets, preventing Git line-ending conversion and text merges from changing their recorded bytes or breaking checksum checks after cloning.
